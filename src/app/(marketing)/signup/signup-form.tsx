                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 border border-white/8 bg-white/[0.02] hover:bg-white/5 hover:border-white/15 text-white/40 hover:text-white/70 transition-all duration-300 py-3 text-[10px] tracking-[0.15em] uppercase font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {oauthLoading === 'github' ? (
                                <Loader2 className="h-4 w-4 animate-spin" />
                            ) : (
