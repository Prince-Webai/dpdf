...
export default function PersonalAnnualSubscription() {
        ...
        <div className="flex flex-col min-h-screen pt-32 pb-24 relative overflow-hidden bg-black text-white">
                ...
                {!isSuccess ? (
                    <>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            ...
                            >
                                <div>
                                    <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold uppercase tracking-wider mb-4">
                                        Save 20%
                                    </div>
                                    <h1 className="text-4xl font-bold mb-4">Complete your subscription</h1>
                                    <p className="text-gray-400 text-lg">You&apos;re subscribing to the <span className="text-indigo-400 font-semibold">Personal Annual</span> plan.</p>
                                </div>

                                <div className="space-y-4">
                                    {[
                                        '37,000 Credits per month',
                                        'Full API access',
                                        '60-min link expiry',
                                        'Priority Support'
                                    ].map((feature, i) => (
                                ...
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-4">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-white">$22.99 / mo</span>
                                    </div>
                                    <div className="pt-4 border-t border-white/10 flex justify-between items-center">
                                        <span className="text-lg font-semibold">Total today</span>
                                        <span className="text-2xl font-bold text-white">$275.88</span>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div id="paypal-button-container-P-4B6563621U646290YNGRS3QY" className="min-h-[150px] flex items-center justify-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400">
                            Thank you for subscribing to the <span className="text-white font-semibold">Personal Annual</span> plan. Your account has been upgraded and your credits are now available for the entire year.
                        </p>
            ...
            <Script
                ...
                onLoad={() => {
                    // @ts-ignore
                    if (window.paypal) {
                        const container = document.getElementById('paypal-button-container-P-4B6563621U646290YNGRS3QY');
                        ...
                        window.paypal.Buttons({
                            ...
                            createSubscription: function (data: any, actions: any) {
                                return actions.subscription.create({
                                    plan_id: 'P-4B6563621U646290YNGRS3QY'
                                });
                            },
                        ...
                        }).render('#paypal-button-container-P-4B6563621U646290YNGRS3QY');
                    }
                }}
            />
        </div>
