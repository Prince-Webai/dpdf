                ...
                {!isSuccess ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-gray-400 text-lg">You&apos;re subscribing to the <span className="text-indigo-400 font-semibold">Basic Annual</span> plan.</p>
                                </div>
                                ...
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-4">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-white">$13.99 / mo</span>
                                    </div>
                                    <div className="pt-4 border-t border-white/10 flex justify-between items-center">
                                        <span className="text-lg font-semibold">Total today</span>
                                        <span className="text-2xl font-bold text-white">$167.88</span>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div id="paypal-button-container-P-7EM20174BJ695260FNGRS23A" className="min-h-[150px] flex items-center justify-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400">
                            Thank you for subscribing to the <span className="text-white font-semibold">Basic Annual</span> plan. Your account has been upgraded and your credits are now available for the entire year.
                        </p>
